...
{
    public class ONetPICPositionViewModel : IDialogAware
    {
        public ONetPICPosition ToolIns { get; set; }
        /// <summary>
        /// 取消命令
        /// </summary>
        ...
        public ONetPICPositionViewModel(IMotionSystemService motionSystemService, IEventAggregator eventAggregator, IDialogService dialogService)
        {
            _eventAggregator = eventAggregator;
            _dialogService = dialogService;
            _motionSystemService = motionSystemService;

            ToolIns = new ONetPICPosition();
        ...
        public void OnDialogOpened(IDialogParameters parameters)
        {
            ...
            {
                ToolIns = (ONetPICPosition)toolIns;
            }
        }
        #endregion

...
{
    public class GolightOSMWD41310_B_ViewModel : BindableBase
    {
        ...
        public GolightOSMWD41310_B_ViewModel(IEventAggregator eventAggregator, IContainerProvider containerProvider, IDataBindingContext dataBinding, ILogger logger)
        {
            // 初始化通道数据
            ...
            _golightOSMWD41310Helper = _containerProvider.Resolve<GolightOSMWD41310Helper>("LaserLightSourceB");
        ...
        private void OnAppStartUpEvent(object obj)
        {
            try
            {
                var portNum = _dataBinding.Get("仪表端口号", "激光光源_B").Value;

...
{
    public class ONetFACouplingCorrectionViewModel : IDialogAware
    {
        public ONetFACouplingCorrection ToolIns { get; set; }
        /// <summary>
        /// 取消命令
        /// </summary>
        ...
        public ONetFACouplingCorrectionViewModel(IMotionSystemService motionSystemService, IEventAggregator eventAggregator, IDialogService dialogService)
        {
            _eventAggregator = eventAggregator;
            _dialogService = dialogService;
            _motionSystemService = motionSystemService;

            ToolIns = new ONetFACouplingCorrection();
        ...
        public void OnDialogOpened(IDialogParameters parameters)
        {
            ...
            {
                ToolIns = (ONetFACouplingCorrection)toolIns;
            }
        }
        #endregion
    }

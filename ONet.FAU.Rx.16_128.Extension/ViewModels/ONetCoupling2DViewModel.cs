...
{
    public class ONetCoupling2DViewModel : IDialogAware
    {
        public ONetCoupling2D ToolIns { get; set; }
        /// <summary>
        /// 取消命令
        /// </summary>
        ...
        public ONetCoupling2DViewModel(IMotionSystemService motionSystemService, IEventAggregator eventAggregator, IDialogService dialogService)
        {
            _eventAggregator = eventAggregator;
            _dialogService = dialogService;
            _motionSystemService = motionSystemService;

            ToolIns = new ONetCoupling2D();
        ...
        public void OnDialogOpened(IDialogParameters parameters)
        {
            ...
            {
                ToolIns = (ONetCoupling2D)toolIns;
            }
        }
        #endregion
